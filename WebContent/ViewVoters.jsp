...
<%@page
	import="com.mvc.dao.VoterRegisterDao,com.mvc.bean.VotersRegisterBean,com.mvc.util.DBConnection"%>
...
select studentid,studentname,gender,department,year,password,repeatpassword from voter
</sql:query>
