...
<marquee class="scrollmarq">Welcome To Online Election Voting for Sreerama Engineering College</marquee>
	...
	<form name="form" action="DeleteNominees" method="post"
		onsubmit="return validate()">
		<div class="container">
			<h1>Nominees Details</h1>
			<hr>

				 <label for="nomineenamedelete"><b class="nominee">Nominee Name</b></label>
				<%
	Connection con = null;
	...
	String sql = "SELECT nomineename,nomineeid FROM nominees";
	ps = con.prepareStatement(sql);
	ResultSet rs = ps.executeQuery(); 
	%>
    <select name=nomineename class="delete">
    <option value="0">select nomineename</option>
    <%
	while(rs.next())
	{
	String nomineename = rs.getString(1);
	String nomineeid = rs.getString(2);
	%>
    <option value="<%=nomineeid%>"><%=nomineename%></option>
    <%
	}
	%>
	</select><br></br>
...
: request.getAttribute("errMessage")%>
			...
			<button type="submit" class="registerbtn">Delete Nominees</button>
